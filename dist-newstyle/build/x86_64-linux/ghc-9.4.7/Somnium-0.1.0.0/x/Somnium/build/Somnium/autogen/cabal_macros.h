...
/* package Somnium-0.1.0.0 */
#ifndef VERSION_Somnium
#define VERSION_Somnium "0.1.0.0"
#endif /* VERSION_Somnium */
#ifndef MIN_VERSION_Somnium
#define MIN_VERSION_Somnium(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Somnium-0.1.0.0-inplace-Somnium"
