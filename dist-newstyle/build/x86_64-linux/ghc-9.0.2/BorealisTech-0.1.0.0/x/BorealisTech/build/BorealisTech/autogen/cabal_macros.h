...
/* package BorealisTech-0.1.0.0 */
#ifndef VERSION_BorealisTech
#define VERSION_BorealisTech "0.1.0.0"
#endif /* VERSION_BorealisTech */
#ifndef MIN_VERSION_BorealisTech
#define MIN_VERSION_BorealisTech(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BorealisTech */
...
#define CURRENT_COMPONENT_ID "BorealisTech-0.1.0.0-inplace-BorealisTech"
